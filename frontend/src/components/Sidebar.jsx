...
const Sidebar = () => {
  ...
  return (
    <div
      className='h-full items-start justify-between bg-slate-900 border-r-3 border-sky-500 dark:border-slate-800 p-5 flex flex-col gap-10 w-80 max-w-80 min-w-80'
    >
      <div
