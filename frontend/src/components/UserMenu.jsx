...
const UserMenu = ({ userMenuToggle, setUserMenuToggle }) => {
  ...
  return (
    <div
      className={`absolute top-14 right-0 w-64 min-h-40 h-fit pb-o.5 flex-col rounded-sm items-start justify-start shadow-slate-800 dark:border-2 dark:border-slate-800 dark:bg-slate-900 shadow dark:shadow-none ${userMenuToggle ? "flex" : "hidden"}`}
      ref={checkClickRef}
    >
